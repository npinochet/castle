...
* A dungeon full of abandoned deadly attractions, where people paid (to a greedy man) for a *supposed* certain death.
...
The dungeons of the castle has been taken by the castle's jester named Ferragus, which he used to make a series of deadly attractions (with the dungeons torture devices) and charge an entry fee to *surely end yourself*. At the end one can find the jester over a useless pile of gold.
