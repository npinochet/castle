...
func (b *BlockComponent) BlockHurt(otherHc *comp.HitboxComponent, col bump.Colision) {
	b.body.Vy -= 30
...
func (b *BlockComponent) BlockBlock(otherHc *comp.HitboxComponent, col bump.Colision) {
	force := 50.0
	if col.Normal.X > 0 {
		force *= -1
	}
